...
export const DOMAIN_HEATMAP: Record<string, { label: string; icon: string; score: number; trend: string }[]> = {
    geopolitics: [
        { label: "Energy", icon: "Zap", score: 72, trend: "Rising" },
        { label: "Trade", icon: "RefreshCw", score: 65, trend: "Stable" },
        { label: "Defense", icon: "ShieldAlert", score: 81, trend: "Escalating" },
        { label: "Climate", icon: "Leaf", score: 40, trend: "Declining" },
    ],
    economics: [
        { label: "Inflation", icon: "TrendingUp", score: 61, trend: "Rising" },
        { label: "Trade Deficit", icon: "RefreshCw", score: 68, trend: "Stable" },
        { label: "Fiscal Risk", icon: "Banknote", score: 55, trend: "Stable" },
        { label: "FDI Inflow", icon: "Landmark", score: 44, trend: "Declining" },
    ],
    defense: [
        { label: "China Threat", icon: "AlertTriangle", score: 85, trend: "Escalating" },
        { label: "Pakistan Risk", icon: "Swords", score: 78, trend: "Rising" },
        { label: "Cyber Threats", icon: "Monitor", score: 70, trend: "Rising" },
        { label: "Maritime", icon: "Ship", score: 62, trend: "Stable" },
    ],
    technology: [
        { label: "AI Race", icon: "Bot", score: 65, trend: "Rising" },
        { label: "Semiconductor", icon: "Cpu", score: 72, trend: "Rising" },
        { label: "Cyber Threats", icon: "ShieldAlert", score: 80, trend: "Escalating" },
        { label: "Data Sovereignty", icon: "Database", score: 55, trend: "Stable" },
    ],
    climate: [
        { label: "Monsoon Risk", icon: "CloudRain", score: 75, trend: "Rising" },
        { label: "Air Pollution", icon: "Wind", score: 82, trend: "Escalating" },
        { label: "Water Stress", icon: "Droplets", score: 68, trend: "Stable" },
        { label: "Heat Stress", icon: "Thermometer", score: 77, trend: "Rising" },
    ],
    society: [
        { label: "Healthcare Gap", icon: "Hospital", score: 58, trend: "Stable" },
        { label: "Education", icon: "BookOpen", score: 62, trend: "Stable" },
        { label: "Inequality", icon: "Scale", score: 70, trend: "Rising" },
        { label: "Youth Unemp.", icon: "UserX", score: 72, trend: "Rising" },
    ],
};
...
export const IMPACT_CARDS: Record<string, { title: string; tag?: string; tagColor?: string; line1: string; line2: string; icon: string }[]> = {
    geopolitics: [
        { title: "Strategic Oil Reserves", tag: "EI.40", tagColor: "#3B82F6", line1: "Brent Crude rise n 6.8/p 30 days", line2: "Defense Perve:ite Ductner 39.5", icon: "Fuel" },
        { title: "Diplomatic Realignment", line1: "Russia-India ties reaffirmed", line2: "Quad meeting scheduled Dec 2025", icon: "Handshake" },
        { title: "Semiconductor Manufacturing", line1: "Export controls: tightened", line2: "India fab investment accelerating", icon: "Cpu" },
    ],
    economics: [
        { title: "Brent Crude Rise", line1: "Energy import cost | net Pecets", line2: "OPEC production cut rumors circulate", icon: "Zap" },
        { title: "RBI Rate Decision", tag: "LIVE", tagColor: "#EF4444", line1: "Inflation at 5.1%, rates held steady", line2: "Rupee at 83.2 vs USD", icon: "Landmark" },
        { title: "Trade Deficit Widening", line1: "Merchandise deficit $24.2B Nov", line2: "Oil & gold imports drive gap", icon: "TrendingDown" },
    ],
    defense: [
        { title: "LAC Infrastructure", tag: "ALERT", tagColor: "#EF4444", line1: "China builds new road near Depsang", line2: "Satellite imagery confirms activity", icon: "ShieldAlert" },
        { title: "Hypersonic Test", tag: "DRDO", tagColor: "#3B82F6", line1: "India tests glide vehicle terminal", line2: "Joins elite 5-nation club", icon: "Rocket" },
        { title: "Cyber Incident India", line1: "APT group targets power grid", line2: "CERT-IN issues high-severity alert", icon: "Monitor" },
    ],
    technology: [
        { title: "BharatGPT Deployment", tag: "LIVE", tagColor: "#10B981", line1: "Multilingual LLM goes live gov use", line2: "6 Indian languages, 10B params", icon: "Bot" },
        { title: "Semiconductor Fab Gujarat", line1: "First chips off production line", line2: "Import dependency −12% in 18 months", icon: "Cpu" },
        { title: "US Chip Export Controls", tag: "IMPACT", tagColor: "#F97316", line1: "Advanced AI chips restricted", line2: "India seeks exemption under tech pact", icon: "PackageX" },
    ],
    climate: [
        { title: "Monsoon Deficit Alert", tag: "HIGH", tagColor: "#EF4444", line1: "22% below normal NW India", line2: "Kharif crop output −15% projected", icon: "CloudRain" },
        { title: "Solar 100 GW Milestone", tag: "ACHIEVED", tagColor: "#10B981", line1: "Cumulative solar crosses 100 GW", line2: "FY2026 target: 150 GW on track", icon: "Sun" },
        { title: "Ganga Pollution Crisis", line1: "UP industrial effluents unchecked", line2: "CPCB issues contempt notices", icon: "Waves" },
    ],
    society: [
        { title: "Urban Population 500M", tag: "MILESTONE", tagColor: "#3B82F6", line1: "Urbanization drives GDP growth", line2: "Infrastructure strain intensifying", icon: "Building2" },
        { title: "PM-JAY Expansion", tag: "LIVE", tagColor: "#10B981", line1: "600M beneficiaries enrolled", line2: "85% utilization tier-2 cities", icon: "Hospital" },
        { title: "Education Gap Report", line1: "27% rural students reach higher edu", line2: "ASER report: urban-rural divide widens", icon: "BookOpen" },
    ],
};
